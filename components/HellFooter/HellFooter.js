  ...
  <div className="">
    ...
    >
      <svg
        ...
        x="0px" y="0px"
        viewBox="0 0 256 256"
        className="w-32 h-auto fill-current text-white bg-blacky ">
        <g>
    ...
    <footer className="bg-blacky min-h-60">
        <div className="container mx-auto flex space-between sm:pl-5 sm:pr-5">
          <div className="grid md:grid-cols-2 grid-cols-1 w-full">
            ...
            <div className="flex justify-center md:justify-end w-full text-white items-center -mt-3 pt-7 md:pt-0">
              <a
                title="Follow me in my Instagram account"
                href="https://www.instagram.com/helmona.shop/?hl=en" 
                target="_blank" 
                className="mr-4"
                rel="noreferrer">
                <svg 
              ...
              <a
                title="Follow me in my Facebook account"
                href="https://www.facebook.com/HelmonaShop/" 
                target="_blank" 
                className="mr-4"
                rel="noreferrer">
                <svg 
                  ...
                  <g>
                    ...
                    <path style={{fill:'#000000'}} d="M163.394,100.277h18.772v-27.73h-22.067v0.1c-26.738,0.947-32.218,15.977-32.701,31.763h-0.055
              ...
              <a
                title="Follow me in my Etsy account" 
                href="https://www.etsy.com/shop/HELMONA#" 
                target="_blank" 
                className="mr-4"
                rel="noreferrer">
                <svg 
              ...
              <a
                title="Follow me in my Sashe account" 
                href="https://www.sashe.sk/helmona" 
                target="_blank" 
                className="mr-4"
                rel="noreferrer">
                <svg 
              ...
              <a
                ...
                <svg 
                  ...
                  className="w-10 h-auto">
                  <g>
                    <circle style={{fill:'#FFF'}} cx="56.099" cy="56.1" r="56.098"/>
                    <g>
                      <path style={{fill:'#000'}} d="M60.627,75.122c-4.241-0.328-6.023-2.431-9.349-4.45c-1.828,9.591-4.062,18.785-10.679,23.588
