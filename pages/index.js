...
import  SectionMainA from '@components/SectionMainA'
import  SectionMainB from '@components/SectionMainB'
import  SectionMainC from '@components/SectionMainC'
  ...
  return (
    <div className="w-full h-screen">
      <main className="relative w-full h-4/5 overflow-hidden">
        <img 
          src="/storefront/assets/_MG_4432.JPG" 
      ...
      <footer className="bg-blacky">
        <div className="container mx-auto pt-6 flex space-between">
          <div className="grid grid-cols-2 w-full">
            ...
            <div className="flex justify-end text-white items-center -mt-3">
              <a
